...
[TensorComputes]
    ...
    [Solve]
        ...
        [sigma_gr0_gr1]
            ...
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R1_R2.pt'
            chunk_size = 1e5
        []
        [sigma_gr0_gr2]
            type = PairwiseAnisotropicGBEnergy
            ...
            interface_width = '${interface_width}'
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R1_R3.pt'
            chunk_size = 1e5
        []
        [sigma_gr0_gr3]
            type = PairwiseAnisotropicGBEnergy
            ...
            interface_width = '${interface_width}'
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R1_R4.pt'
            chunk_size = 1e5
        []
        [sigma_gr0_gr4]
            type = PairwiseAnisotropicGBEnergy
            ...
            interface_width = '${interface_width}'
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R1_R5.pt'
            chunk_size = 1e5
        []
        [sigma_gr1_gr2]
            type = PairwiseAnisotropicGBEnergy
            ...
            grad_grain2_buffer = 'grad_gr2'
            interface_width = '${interface_width}'
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R2_R3.pt'
            chunk_size = 1e5
        []
        [sigma_gr1_gr3]
            type = PairwiseAnisotropicGBEnergy
            ...
            grad_grain2_buffer = 'grad_gr3'
            interface_width = '${interface_width}'
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R2_R4.pt'
            chunk_size = 1e5
        []
        [sigma_gr1_gr4]
            type = PairwiseAnisotropicGBEnergy
            ...
            grad_grain2_buffer = 'grad_gr4'
            interface_width = '${interface_width}'
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R2_R5.pt'
            chunk_size = 1e5
        []
        [sigma_gr2_gr3]
            type = PairwiseAnisotropicGBEnergy
            ...
            grad_grain2_buffer = 'grad_gr3'
            interface_width = '${interface_width}'
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R3_R4.pt'
            chunk_size = 1e5
        []
        [sigma_gr2_gr4]
            type = PairwiseAnisotropicGBEnergy
            ...
            grad_grain2_buffer = 'grad_gr4'
            interface_width = '${interface_width}'
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R3_R5.pt'
            chunk_size = 1e5
        []
        [sigma_gr3_gr4]
            type = PairwiseAnisotropicGBEnergy
            ...
            grad_grain2_buffer = 'grad_gr4'
            interface_width = '${interface_width}'
            libtorch_model_file = '/home/bhavcv/projects/torch-gb5dof/Ni_R4_R5.pt'
            chunk_size = 1e5
        []
        ...
        #     expression = '${kappa} * (k2*gr0_bar + k2*gr1_bar + k2*gr2_bar + k2*gr3_bar + k2*gr4_bar)'
        #     inputs = 'gr0_bar gr1_bar gr2_bar gr3_bar gr4_bar'
        #     extra_symbols = true
        # []
        ...
        #     inputs = 'gr0 gr1 gr2 gr3 gr4 gamma_01 gamma_02 gamma_03 gamma_04 gamma_12 gamma_13 gamma_14 gamma_23 gamma_24 gamma_34 kappa_laplacian_gr_i'
        # []
    []
[]

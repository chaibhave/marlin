#
# Kim-Kim-Suzuki solved on a 2D grid.
# Uses IMEXStabilization to improve time step size stability
#
...
[TensorComputes]
    ...
    [Solve]
        ...
        []
        [stabilization_term]
            type = IMEXStabilization
            buffer = linear_C
            nonlinear_reciprocal = div_J
            v_bar = cbar
        []
        [NL_stab_bar]
            type = ParsedCompute
            buffer = NL_stab_bar
            expression = 'div_J - linear_C*cbar'
            inputs = 'linear_C div_J cbar'
        []
        # [NL_stab]
        #     type = InverseFFT
        #     buffer = NL_stab
...
#     linear_reciprocal = 'linear_C zero'
#     nonlinear_reciprocal = 'NL_stab_bar AC_bar'
#     substeps = 1e3
#     predictor_order = 3
# []
[TensorSolver]
...
[TensorOutputs]
    [xdmf]
        ...
        buffer = 'eta c mu psi div_J_real'
        enable_hdf5 = true
        transpose = false
    []
[]
